...
class UIViewModel(val activity: Application) : AndroidViewModel(activity) {
    ...
    private fun themeSwitcher(theme: MainActivity.UITheme) {
        uiDataClass?.let { uiDataClass ->
            ...
            editTextDisplayModifyHintColor.set(colorMapper.map(theme, uiDataClass.editTextHintColor))
            editTextDisplayModifyHintSize.set(textSizeMapper.map(theme, uiDataClass.editTextHintSize))
            editTextDisplayModifyHintTypeface.set(typefaceMapper.map(theme, uiDataClass.editTextHintSize))
            editTextDisplayModifyColor.set(colorMapper.map(theme, uiDataClass.editTextColor))
            editTextDisplayModifySize.set(textSizeMapper.map(theme, uiDataClass.editTextSize))
            editTextDisplayModifyBackgroundColor.set(colorMapper.map(theme, uiDataClass.editTextBackgroundColor))
            editTextDisplayModifyTypeface.set(typefaceMapper.map(theme, uiDataClass.editTextSize))
            editTextDisplayModifyUpperHintColor.set(colorMapper.map(theme, uiDataClass.editTextUpperHintColor))
            editTextDisplayModifyBackground.set(ContextCompat.getDrawable(context, uiDataClass.editTextBackground))
